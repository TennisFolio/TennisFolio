...
public class FakeLiveEventsMapperSecond implements EntityMapper<List<LiveEventsApiDTO>, List<LiveMatchResponse>> {
    @Override
    public List<LiveMatchResponse> map(List<LiveEventsApiDTO> dto, Object... params) {
        return List.of(LiveEventsFixtures.liveMatchInProgress2());
    }
}
